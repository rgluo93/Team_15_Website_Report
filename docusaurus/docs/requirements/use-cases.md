...
| **Education Officer** | A LeadNow staff member who uses the EO Agent to query programme data and generate planning documents. |
...
| **Description** | The user highlights text on the web application, a popup appears with a translate button, and clicking the button displays the translated Swahili text. |
...
| **Description** | The user clicks a record button to capture live audio, which the system transcribes into text and populates the input field. |
...
| **Description** | The Langgraph agent sends a WhatsApp message to a specified phone number via the WhatsApp Business API. |
...
|-------|--------|
| **Actor** | System (via Langgraph Agent) |
| **Description** | The Langgraph agent translates the input text between English and Swahili. |
